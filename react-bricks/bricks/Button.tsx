...
const Button: types.Brick<ButtonProps> = ({
  ...
  return (
    <Link
      href={href}
      {...target}
      className={`text-base text-medium rounded-full transition-color duration-300 ease-in-out cursor-pointer min-w-[120px] w-fit px-4 py-1.5 flex justify-center items-center ${
        type === 'solid'
